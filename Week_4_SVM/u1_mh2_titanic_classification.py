...
df1['Embarked']=df1['Embarked'].map({'S':1,'C':2,'Q':3}).fillna(0).astype(int)
...
df1.drop(columns=['PassengerId', 'Name', 'SibSp', 'Parch', 'Ticket', 'Cabin'],inplace=True)
...
sklearn.linear_model import LinearRegression, LogisticRegression,Perceptron, SGDClassifier,RidgeClassifier,PassiveAggressiveClassifier
from sklearn.neighbors import KNeighborsClassifier
from sklearn.tree impfromort DecisionTreeClassifier
from sklearn.svm import SVC
from sklearn.ensemble import VotingClassifier,BaggingClassifier

models={'lgs':LogisticRegression(),
        #'lr':LinearRegression(), # Removed as it's a regression model in a classification context
        'per':Perceptron(),
        'SGD':SGDClassifier(),
        'Rc':RidgeClassifier(),
        ...
        'vc':VotingClassifier(estimators=[('knn', KNeighborsClassifier(n_neighbors=3)),
